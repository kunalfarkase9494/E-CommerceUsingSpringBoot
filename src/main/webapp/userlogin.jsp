...
<%
String msg = (String)request.getAttribute("umsg");
if(msg!=null){
%>
...
<div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card mt-5">
          <div class="card-body">
            <h3 class="card-title text-center">User's Login</h3>
            <hr>
            ...
            <a href="usersignup.jsp" class="btn btn-outline-primary w-50">Sign Up</a>
            </div>
          </div>
        </div>
      </div>
